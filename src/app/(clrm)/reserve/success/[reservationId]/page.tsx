...
const ReservationCompletePage = ({ params }: { params: { reservationId: string } }) => {
  ...
  return (
    <div className="w-full min-h-100vh-header  box-border  bg-light-purple flex justify-center items-center flex-col text-gray-700">
        ...
        {!isLoading && !isError ? (
          <>
            ...
            <div className="flex flex-col items-center w-full justify-center">
              ...
              <div className="flex flex-col gap-4 font-bold ml-20">
