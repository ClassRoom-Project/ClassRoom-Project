    ...
    <>
      <div id="default-carousel" className="relative w-full" data-carousel="slide">
        ...
        <button
          ...
          data-carousel-prev
        >
          <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-main-color dark:bg-main-color group-hover:bg-main-color dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
            <svg
