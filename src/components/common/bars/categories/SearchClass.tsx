...
export const SearchClass = () => {
  ...
  return (
    <form className="ml-2 flex h-24 w-full items-center justify-start" onSubmit={handleSearchBtn}>
      <div className="xl:[350px] relative flex w-[200px] items-end justify-end rounded-xl border-[1px] border-input-border-color mobile:w-[250px] sm:w-[280px] lg:w-[320px] 2xl:w-[500px]">
