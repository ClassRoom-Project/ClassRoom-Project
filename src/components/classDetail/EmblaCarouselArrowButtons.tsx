...
export const PrevButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button className={`${style.embla__button} ${style.embla__buttonPrev}`} type="button" {...restProps}>
...
export const NextButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button className={`${style.embla__button} ${style.embla__buttonNext}`} type="button" {...restProps}>
      <svg className={style.embla__button__svg} viewBox="0 0 532 532">
        <path
          fill="currentColor"
