  ...
  return (
    <div className="my-4 flex flex-wrap justify-between items-center">
      <div className="w-full md:w-auto md:flex-1 flex items-center space-x-2 my-2">
        <p className="text-base text-[#3F3F3F] flex-shrink-0 font-bold"><span className='text-[#d63232] font-bold'>*</span> 모집 정원</p>
        <input
      ...
      <div className="w-full md:w-auto md:flex-1 flex items-center space-x-2 my-2">
        <p className="text-base text-[#3F3F3F] flex-shrink-0 font-bold"><span className='text-[#d63232] font-bold'>*</span> 최소 모집 인원</p>
        <input
          className="form-input px-3 py-2 border border-[#D5D5D5] rounded w-1/3 md:w-1/3"
          type="text"
          value={minNumber}
